...
#ifdef MAC	// TODO- Mac defines
#define FND_PLATFORM_CURRENT_OS (Fnd::Core::Platform::OS::Mac)
#endif

#ifndef FND_PLATFORM_CURRENT_OS
#define FND_PLATFORM_CURRENT_OS (Fnd::Core::Platform::OS::UnknownOS)
#endif
...
#define FND_PLATFORM_CURRENT_BIT (Fnd::Core::Platform::Bit::UnknownBit)
#endif
...
#define FND_PLATFORM_CURRENT_BUILD (Fnd::Core::Platform::Build::UnknownBuild)
#endif
